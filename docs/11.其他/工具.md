...
[Mermaid](https://mermaid.js.org/) - 是一个基于 JavaScript 的图表库，用于绘制流程图、序列图、类图等。
[AOS](https://michalsnik.github.io/aos/) - 是一个基于 JavaScript 的动画库，用于在页面滚动时添加动画效果。

## 4.vue3组件库

[Vben Admin](https://doc.vben.pro/) - 是一个基于 Vue 3 的组件库，提供了丰富的 UI 组件和工具函数，帮助开发者快速构建现代化的 Web 应用程序。
